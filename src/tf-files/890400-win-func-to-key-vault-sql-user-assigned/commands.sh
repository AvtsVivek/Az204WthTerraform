...
cd ./src/tf-files/890400-win-func-to-key-vault-sql-user-assigned
...
# 0525-AzureFuncKeyVaultSqlDb

dotnet build ./../../dotnet-apps/0525-AzureFuncKeyVaultSqlDb/AzureFuncKeyVaultSqlDb.csproj
