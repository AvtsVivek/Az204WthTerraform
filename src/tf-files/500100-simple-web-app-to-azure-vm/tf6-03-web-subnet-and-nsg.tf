...
# For now removing the network security group for web tier subnet
# If we want two levels of security then we will create a network security group for web tier subnet.
/*
# Resource-2: Create Network Security Group (NSG)
# Manages inbound and outbound network traffic to and from the virtual network.
